...
public class SeleniumInit extends ExtentManager {
...
*/
	...
	public void sheetupdate() {
		...
		//For Extent Report
		extent = ExtentManager.createInstance(System.getProperty("user.dir")+"/test-output/Extent_Report.html");
		//ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir")+"/test-output/Extent_Report.html");
	...
	// For the Extended Report
	public void fetchSuiteConfigurationclass(ITestContext testContext) {
		//TestCaseName= testContext.getCurrentXmlTest().getParameter("com.automation.index.PackageIndex");
//        ExtentTest parent = extent.createTest("Demo");
//        parentTest.set(parent);
	...
	public void setUp(Method method, ITestContext testContext) throws Exception {
		...
		// For the Extended Report
		 ...
		 parent.log(Status.INFO, "Log for the reports");
		 PackageIndex.getlogger(parent);
	     parentTest.set(parent);
	     
	   //  ExtentTest test = extent.createTest(TestCaseName+"new");
	   
	     System.out.println("TestName :"+TestName);
	     
		 ExtentTest child = ((ExtentTest) parentTest.get()).createNode(TestName);
	     test.set(child);
	  // For the Extended Report End
	...
	public void tearDown(ITestResult testResult) {
		...
		//For Extent Report
		 if (testResult.getStatus() == ITestResult.FAILURE)
	            ((ExtentTest) test.get()).fail(testResult.getThrowable());
	        else if (testResult.getStatus() == ITestResult.SKIP)
	        	 ((ExtentTest) test.get()).skip(testResult.getThrowable());
